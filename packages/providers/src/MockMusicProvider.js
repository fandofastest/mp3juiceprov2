...
class MockMusicProvider {
    ...
    async search(query, limit = 10) {
        ...
        const filteredTracks = this.mockTracks.filter((t) => t.title.toLowerCase().includes(term) ||
        ...
        const filteredAlbums = this.mockAlbums.filter((a) => a.title.toLowerCase().includes(term) || a.artist.toLowerCase().includes(term));
        return {
...
//# sourceMappingURL=MockMusicProvider.js.map